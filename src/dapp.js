...
const getAccount = async () => {
  await provider.send("eth_requestAccounts", ["0xde34d010673b9f05ed5c14770df1a8e3a39e1f8b"]); // Login to metamask
...
// Sell exact amount of Chron tokens for output tokens using UniswapV2
const sellChron = async (inputAmt, inputAddr, outputAddr) => {
  console.log("sellChron");
  ...
  if (isInputValid === true)
  {
    ...
    try {
      ...
      console.log ("Sell Chron: Failed to get pool reserves");
      throw new Error ('Sell Chron: Failed to get pool reserves');
    };
    ...
    try {
      ...
      console.log (e); 
      throw new Error ('Sell Chron Failed to get approval');
    };   
    ...
    try{
      ...
      console.log(receipt);              
         ...
         console.log ("Sell Chron: Failed to swap");
        throw new Error ('Sell Chron: Failed to swap');
    };    
  }
  else
  {
    console.log ("Sell Chron: Invalid input");
    throw new Error ('Sell Chron: Invalid input');
  };
};

// Buy exact amount of Chron  tokens for input tokens using UniswapV2
const buyChron = async (outputAmt, outputAddr, inputAddr) => {
  console.log("buyChron");
  ...
  if (isInputValid === true)
  {
    ...
    try {
      ...
      console.log ("Buy Chron: Failed to get pool reserves");
      throw new Error ('Buy Chron: Failed to get pool reserves');    
    };
    ...
    try {
      ...
      console.log("Buy Chron: Failed to swap");
      throw new Error("Buy Chron: Failed to swap");
    };
  }
  else
  {
      console.log ("Buy Chron: Invalid input");
      throw new Error ('Buy Chron: Invalid input');
  };
};
